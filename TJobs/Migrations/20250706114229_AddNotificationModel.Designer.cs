...
namespace TJobs.Migrations
{
    ...
    [Migration("20250706114229_AddNotificationModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TJobs.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TJobs.Models.EmployerRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TJobs.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TJobs.Models.WorkerRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TJobs.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TJobs.Models.ChatMessage", b =>
                {
                    b.HasOne("TJobs.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TJobs.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("TJobs.Models.EmployerRating", b =>
                {
                    b.HasOne("TJobs.Models.ApplicationUser", "Employer")
                        .WithMany()
                    ...
                    b.HasOne("TJobs.Models.ApplicationUser", "Worker")
                        .WithMany()
            ...
            modelBuilder.Entity("TJobs.Models.Notification", b =>
                {
                    b.HasOne("TJobs.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
